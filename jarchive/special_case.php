...
$sql="select * from cases where status='1'and pro_decision='prosecution' and jachive_id='".$_SESSION['JARCHIVE_ID']."' and priority='1' order by id desc";
        ...
        <div class = "item-list">
                ...
                <div class = "item">
                    ...
                    <div class = "item-detail">
                        ...
                        <?php if($row['sended']=='0'){ ?>
                            <a href="special_send.php?id=<?php echo $row['id']?>"><label class="btn btn-success hand_cursor">Send to Court</label></a>
                        <?php }else{ ?>
