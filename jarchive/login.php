...
if(isset($_POST['submit'])){
    ...
    $sql="select * from juser where username='$username' and password='$password' and department_id='1' and role_id='3' and status=1";
    $res=mysqli_query($con,$sql);
    if(mysqli_num_rows($res)>0){
      $row=mysqli_fetch_assoc($res);
      $_SESSION['JARCHIVE_IS_LOGIN']='yes';
      $_SESSION['JARCHIVE_USER']=$row['name'];
      $_SESSION['JARCHIVE_USER_NAME']=$row['username'];
      $_SESSION['JARCHIVE_ID']=$row['id'];
      redirect('index.php');
    }else{
