...
$sql="select * from cases where status='1' and pro_decision='incomplete' and incomplete_archive_id='".$_SESSION['JARCHIVE_ID']."' order by id desc";
                ...
                <div class = "item">
                    ...
                    <div class = "item-detail">
                        ...
                        <?php if($row['returned']=='0'){ ?>
                            <a href="case_return.php?id=<?php echo $row['id']?>"><label class="btn btn-success hand_cursor">Send to Police</label></a>
                        <?php }else{ ?>
