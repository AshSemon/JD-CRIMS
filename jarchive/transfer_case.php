...
$sql="select * from cases where status='1' and priority='0' and pro_decision='prosecution' and prosecution_id='".$_SESSION['JARCHIVE_ID']."' order by id desc";
...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class = "item-list">
                ...
                <div class = "item">
                    <div class = "item-img">
                        <a target="_blank" href="<?php echo LOGO_IMAGE_SITE_PATH."6.jpg"?>">
                            <img src="<?php echo LOGO_IMAGE_SITE_PATH."6.jpg"?>"  width="600" height="200"/>
                        </a>
                    </div>
                    <div class = "item-detail">
                        ...
                        ?>
                        <?php if($row['sended']=='0'){ ?>
                            <a href="case_send.php?id=<?php echo $row['id']?>"><label class="btn btn-success hand_cursor">Send to Court</label></a>
                        <?php }else{ ?>
