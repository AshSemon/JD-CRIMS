...
if(isset($_GET['type']) && $_GET['type']!=='' && isset($_GET['id']) && $_GET['id']>0){
    ...
    if($type=='delete'){
		mysqli_query($con,"delete from court_returned where id='$id'");
		redirect('case.php');
	}
	if($type=='active' || $type=='deactive'){
		...
		mysqli_query($con,"update court_returned set status='$status' where id='$id'");
		redirect('case.php');
	}

}

$sql="select * from court_returned order by id desc";
...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class = "item-list">
                ...
                <div class = "item">
                    <div class = "item-img">
                        <a target="_blank" href="<?php echo LOGO_IMAGE_SITE_PATH."7.jpg"?>">
                            <img src="<?php echo LOGO_IMAGE_SITE_PATH."7.jpg"?>"  width="600" height="200"/>
                        </a>
                    </div>
                    <div class = "item-detail">
                        ...
                        <span href = "#" class = "item-name">Investigated by :  <?php echo $row['prosecutor']?></span>
                        ...
                        <?php
                        echo "<h5>Assigned to Procecutor :- ".getProcecutorNameById($row['prosecutor_id'])."</h5>"
                        ?>
                        <a href="return_details.php?id=<?php echo $row['id']?>"><label class="btn btn-primary mr-2 hand_cursor">View Detail</label></a>
