...
if(isset($_GET['id']) && $_GET['id']>0){
  ...
  if(isset($_GET['procecutor'])){
    ...
    mysqli_query($con,"update court_returned set prosecutor_id='$procecutor' where id='$id'");
    redirect(SITE_PATH.'jarchive/case_details.php?id='.$id);
  }
  $sql="SELECT * FROM court_returned where id='$id' ORDER BY id desc";
            ...
            <div class="row">
              ...
              <script>
                function updateprocecutorAssign(){
                  ...
                  if(procecutor!=''){
                    var oid="<?php echo $id?>";
                    window.location.href='<?php echo SITE_PATH?>jarchive/return_details.php?id='+oid+'&procecutor='+procecutor;
                  }
                }
