...
$msg="";
// Create connection
$con = mysqli_connect("localhost:3306","root","","ccrms");
// Check connection
...
if(isset($_GET['id']) && $_GET['id']>0){
  ...
  if(mysqli_num_rows($res)>0){
    mysqli_query($con,"update cases set sended='1' where id='$id'");
