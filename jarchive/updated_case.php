...
$sql="select * from court_returned where status='1' and decision='prosecution' and update_jarchive_id='".$_SESSION['JARCHIVE_ID']."' order by id desc";
...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class = "item-list">
                ...
                <div class = "item">
                    <div class = "item-img">
                        <a target="_blank" href="<?php echo LOGO_IMAGE_SITE_PATH."8.jpg"?>">
                            <img src="<?php echo LOGO_IMAGE_SITE_PATH."8.jpg"?>"  width="600" height="200"/>
                        </a>
                    </div>
                    <div class = "item-detail">
                        ...
                        <?php
                        echo "<h5>Assigned by Procecutor :- ".getProcecutorNameById($row['prosecutor_id'])."</h5>"
                        ?>
                        <?php if($row['sended']=='0'){ ?>
                            <a href="updated_send.php?id=<?php echo $row['id']?>"><label class="btn btn-success hand_cursor">Send to Court</label></a>
                        <?php }else{ ?>
                            <a href="javascript:void(0)"><label class="btn btn-secondary hand_cursor">Sended</label></a>
                        <?php } ?>
