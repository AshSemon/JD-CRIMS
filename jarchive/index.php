...
<div class="main-panel">
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <h1 class="font-weight-light mb-4">
                        ...
                        $sql="select * from cases where jachive_id='".$_SESSION['JARCHIVE_ID']."' and added_on between '".date('Y-m-d')." 00-00-00' and '".date('Y-m-d')." 23-59-59'";
            ...
            <div class="card">
                <div class="card-body">
                    <h1 class="font-weight-light mb-4">
                        ...
                        $sql="select * from cases where jachive_id='".$_SESSION['JARCHIVE_ID']."' and added_on between '$start' and '".date('Y-m-d')." 23-59-59'";
                        $res=mysqli_query($con,$sql);
                        if($row=mysqli_num_rows($res)){
                            echo"<h4 class='mb-0'>".$row."</h4>";
                        }else{
        ...
        <!-- latest 5 -->
    <?php
    $sql="select * from cases where status='1' and jachive_id='".$_SESSION['JARCHIVE_ID']."' order by id desc limit 5";
    $res=mysqli_query($con,$sql);
    ?>
    <div class="row">
        <div class="col-12">
