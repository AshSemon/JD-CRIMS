...
$sql="select * from decided where status='1' order by id desc";
...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class = "item-list">
                ...
                <div class = "item">
                    <div class = "item-img">
                        <a target="_blank" href="<?php echo LOGO_IMAGE_SITE_PATH."4.png"?>">
                            <img src="<?php echo LOGO_IMAGE_SITE_PATH."4.png"?>"  width="600" height="200"/>
                        </a>
                    </div>
                    <div class = "item-detail">
                        ...
                        <span href = "#" class = "item-name">Closed Date :  <?php echo $row['decision_date']?></span>
                        
                        <?php if($row['sended']=='0'){ ?>
                            <a href="share_send.php?id=<?php echo $row['id']?>"><label class="btn btn-success hand_cursor">Share Decision</label></a>
                        <?php }else{ ?>
                            <a href="javascript:void(0)"><label class="btn btn-secondary hand_cursor">Shared</label></a>
                        <?php } ?>
                    </div>
                </div>
                <?php 
