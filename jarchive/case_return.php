...
if(isset($_POST['submit'])){
  ...
  if($id==''){
		$sql="select * from returned where caseid='$caseid' ";
	}else{
		$sql="select * from returned where caseid='$caseid' and id!='$id'";
	}
  if(mysqli_num_rows(mysqli_query($con,$sql))>0){
		$msg="Case already returned";	
	}else{
    mysqli_query($con,"insert into returned(caseid,priority,casetype,accuser,agender,adob,aaddress,aphone,awork,pstatement,defendent,dgender,ddob,dmother,dfather,dwork,dfamily,daddress,dphone,dstatement,cine,accusation,imprisioned,arn,investigated,prosecutor,jachive,witness,statement,invest_statement,pro_statement,status,added_on) values('$caseid','$priority','$casetype','$accuser','$agender','$adob','$aaddress','$aphone','$awork','$pstatement','$defendent','$dgender','$ddob','$dmother','$dfather','$dwork','$dfamily','$daddress','$dphone','$dstatement','$cine','$accusation','$imprisioned','$arn','$detective','$prosecuter','$archive','$witness','$statement','$invest_statement','$pro_statement',1,'$added_on')");
...
if(isset($_GET['id']) && $_GET['id']>0){
  ...
  if(mysqli_num_rows($res)>0){
    mysqli_query($con,"update cases set returned='1' where id='$id'");
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
        ...
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.php"><img src="<?php echo LOGO_IMAGE_SITE_PATH."1.jpg"?>" alt="logo"/></a>&nbsp;&nbsp;Wadu Anba Police Station<br>&nbsp;&nbsp;Crime Record Management System<br>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <span class="nav-profile-name"><?php echo $_SESSION['ARCHIVE_USER_NAME']?></span>
            </a>
                        ...
                        <div class="content">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" placeholder="Accuser Gender" name="agender" required value="<?php echo $courtRow['agender']?>"readonly>
                            </div>
                      ...
                      <div class="contentBx">
                        ...
                        <br>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Investigater Name" name="prosecuter" required readonly value="<?php echo getProcecutorNameById($courtRow['prosecutor_id'])?>">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputName1">Assigned by :  </label>
                            <input type="text" class="form-control" placeholder="Archive Name" name="archive" required value="<?php echo getArchiveById($courtRow['jachive_id'])?>"readonly>
                          </div>
                          ...
                          <div class="form-group" id="dish_box1">
                            ...
                            <?php 
                            $cases_prosecution_res=mysqli_query($con,"select * from prosecution where status='1' and cases_id='".$courtRow['id']."' order by id asc");
                            while($cases_prosecution_row=mysqli_fetch_assoc($cases_prosecution_res)) {
                            ?>
                            <div class="form-group">
                              <label for="exampleInputName1">Prosecution statement</label>
                              <textarea class="form-control" placeholder="Prosecution statement" name="pro_statement" id="" cols="30" rows="10" readonly><?php echo $cases_prosecution_row['statemant']?></textarea>
                            </div>
                            <?php } ?>
                        </div>
