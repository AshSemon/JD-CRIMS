...
$sql="select * from cases where pro_decision='canceled' and pcheck_id='".$_SESSION['PROSECUTOR_ID']."' order by id desc ";
                    ...
                    <div class = "item-detail">
                        ...
                        <div class = "item-price">
                            <span class = "new-price">
                                <?php
                                    $caseid=$row['caseid'];
                                    $sql="select pro_decision from cases where status='1' and prosecutor_id='".$_SESSION['PROSECUTOR_ID']."' and caseid='$caseid' order by id desc";
                        ...
                        <a href="recheck_detail.php?id=<?php echo $row['id']?>"><label class="btn btn-primary mr-2 hand_cursor">View Detail</label></a>
