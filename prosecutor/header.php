...
if(!isset($_SESSION['PROSECUTOR_IS_LOGIN'])){
    redirect('login.php');
}
...
if($cur_path=='' || $cur_path=='index.php'){
	$page_title='Prosecutor Dashboard';
	...
	$page_title='Returned Cases';
}elseif($cur_path=='recheck.php' ){
	$page_title='Recheck Cases';
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <span class="nav-profile-name"><?php echo $_SESSION['PROSECUTOR_USER']?></span>
            </a>
    ...
    <div class="container-fluid page-body-wrapper">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="recheck.php">
              <i class="mdi mdi-account-card-details menu-icon"></i>
              <span class="menu-title">Recheck Cases</span>
            </a>
          </li>
		  <li class="nav-item">
