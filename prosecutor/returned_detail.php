                  ...
                  <div class="card-body">
                    ...
                    <div class="container-fluid mt-5 d-flex justify-content-center w-100">
                      <div class="table-responsive w-100">
                        ...
                        <?php 
                          $prosecution_res=mysqli_query($con,"select * from prosecution where decision='incomplete' and status='1' and cases_id='".$courtRow['id']."' order by id asc");
                        ?>
                        <p>
                          <?php
                    ...
                    <?php
                        ...
                        <div>
                          <?php
                          echo "<h4>Assign to Court :- ".getProcecutorNameById($courtRow['prosecutor_id'])."</h4>"
                          ?>
