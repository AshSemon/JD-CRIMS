...
if(isset($_GET['id']) && $_GET['id']>0){
  ...
  if(isset($_GET['detective'])){
    ...
    mysqli_query($con,"update cases set dassign_id='$detective' where id='$id'");
    redirect(SITE_PATH.'prosecutor/case_detail.php?id='.$id);
  }
            ...
            <div class="row">
                    ...
                    <div class="container-fluid mt-5 d-flex justify-content-center w-100">
                      <div class="table-responsive w-100">
                        ...
                        <p>
                          ...
                          ?>
                            <h4><strong>Prosecution</strong>&nbsp;<small>Statement</small></h4>
                            <?php
              ...
              <script>
                ...
                function updateAssign(){
                  ...
                  if(detective!=''){
                    var oid="<?php echo $id?>";
                    window.location.href='<?php echo SITE_PATH?>prosecutor/case_detail.php?id='+oid+'&detective='+detective;
                  }
                }
                function updatejarchiveAssign(){
                  ...
                  if(jarchive!=''){
                    var oid="<?php echo $id?>";
                    window.location.href='<?php echo SITE_PATH?>prosecutor/case_detail.php?id='+oid+'&jarchive='+jarchive;
                  }
                }
              </script>
