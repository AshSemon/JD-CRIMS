...
$sql="select * from court_returned where prosecutor_id='".$_SESSION['PROSECUTOR_ID']."' order by id desc ";
...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class = "item-list">
                ...
                <div class = "item">
                    <div class = "item-img">
                        <a target="_blank" href="<?php echo LOGO_IMAGE_SITE_PATH."9.png"?>">
                            <img src="<?php echo LOGO_IMAGE_SITE_PATH."9.png"?>"  width="600" height="200"/>
                        </a>
                    </div>
                    <div class = "item-detail">
                        ...
                        <div class = "item-price">
                            <span href = "#" class = "item-name">Decision :  <?php echo $row['decision']?></span>
                        </div>
                        <?php
                        echo "<h5>Assign to Archive :- ".getArchiveById($row['update_jarchive_id'])."</h5>"
                        ?>
                        <p>Crime Cine:  <?php echo $row['cine']?></p>
                        <p>Accusation date:  <?php echo $row['accusation']?></p>

                        <?php if($row['prosecution']==''){ ?>
                            <a href="manage_return.php?id=<?php echo $row['id']?>"><label class="btn btn-success mr-2 hand_cursor">Add Prosecution</label></a>
                        <?php }else{ ?>
                            <?php if($row['update_jarchive_id']=='0'){ ?>
                                <a href="manage_return.php?id=<?php echo $row['id']?>"><label class="btn btn-secondary mr-2 hand_cursor">Edit Prosecution</label></a>&nbsp;
                            <?php }else{ ?>
                                
                            <?php } ?>
                        <?php } ?>
                        <a href="returned_details.php?id=<?php echo $row['id']?>"><label class="btn btn-primary mr-2 hand_cursor">View Detail</label></a>
