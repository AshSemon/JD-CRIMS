...
if(isset($_GET['id']) && $_GET['id']>0){
  ...
  if(isset($_GET['jarchive'])){
    ...
    mysqli_query($con,"update court_returned set update_jarchive_id='$jarchive' where id='$id'");
    redirect(SITE_PATH.'prosecutor/returned_details.php?id='.$id);
  }
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div>
                  <div class="container-fluid w-100">
                    ...
                    <div>
                      <?php
                      echo "<h4>Assign to Archive :- ".getArchiveById($courtRow['update_jarchive_id'])."</h4>"
                      ?>
              ...
              <script>
                function updatejarchiveAssign(){
                  ...
                  if(jarchive!=''){
                    var oid="<?php echo $id?>";
                    window.location.href='<?php echo SITE_PATH?>prosecutor/returned_details.php?id='+oid+'&jarchive='+jarchive;
                  }
                }
