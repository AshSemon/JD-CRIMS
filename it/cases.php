            ...
            <div class="card">
                <div class="card-body">
                    <h1 class="font-weight-light mb-4">
                        ...
                        $sql="select * from cases where added_on between '".date('Y-m-d')." 00-00-00' and '".date('Y-m-d')." 23-59-59' and priority='0'";
            ...
            <div class="card">
                <div class="card-body">
                    <h1 class="font-weight-light mb-4">
                        ...
                        $sql="select * from cases where added_on between '$start' and '".date('Y-m-d')." 23-59-59' and priority='0'";
                        $res=mysqli_query($con,$sql);
                        if($row=mysqli_num_rows($res)){
                            echo"<h4 class='mb-0'>".$row."</h4>";
                        }else{
            ...
            <div class="card">
                <div class="card-body">
                    <h1 class="font-weight-light mb-4">
                        ...
                        $start=date('Y-m-d'). '00-00-00';
                        $end=date('Y-m-d'). '23-59-59';
                        $sql="select * from cases where added_on between '".date('Y-m-d')." 00-00-00' and '".date('Y-m-d')." 23-59-59' and priority='1'";
                        $res=mysqli_query($con,$sql);
                        if($row=mysqli_num_rows($res)){
                            echo"<h4 class='mb-0'>".$row."</h4>";
                        }else{
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        <div>
                            <h4 class="font-weight-normal">Today Special Cases</h4>
                            <p class="text-muted mb-0 font-weight-light">Last 24 Hours</p>
                        </div>
                        <i class="mdi mdi-account-card-details icon-lg text-primary ml-auto"></i>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <h1 class="font-weight-light mb-4">
                        ...
                        $sql="select * from cases where added_on between '$start' and '".date('Y-m-d')." 23-59-59' and priority='1'";
                        $res=mysqli_query($con,$sql);
                        if($row=mysqli_num_rows($res)){
                            echo"<h4 class='mb-0'>".$row."</h4>";
                        }else{
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        <div>
                            <h4 class="font-weight-normal">Week Special Cases</h4>
                            <p class="text-muted mb-0 font-weight-light">Last 7 Days</p>
                        </div>
                        <i class="mdi mdi-account-card-details icon-lg text-primary ml-auto"></i>
                    </div>
        ...
        <div class="col-md-6 col-lg-3 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        <div>
                            <h4 class="font-weight-normal">Month Special Cases</h4>
                            <p class="text-muted mb-0 font-weight-light">Last 30 Days</p>
                        </div>
                        <i class="mdi mdi-account-card-details icon-lg text-primary ml-auto"></i>
                    </div>
        ...
        <div class="col-md-6 col-lg-3 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        <div>
                            <h4 class="font-weight-normal">Year Special Cases</h4>
                            <p class="text-muted mb-0 font-weight-light">Last 365 Days</p>
                        </div>
                        <i class="mdi mdi-account-card-details icon-lg text-primary ml-auto"></i>
                    </div>
