...
<div class="main-panel">
            ...
            <div class="card">
                <div class="card-body">
                    <h1 class="font-weight-light mb-4">
                        ...
                        $sql="select * from juser where added_on between '$start' and '".date('Y-m-d')." 23-59-59' ";
            ...
            <div class="card">
                <div class="card-body">
                    <h1 class="font-weight-light mb-4">
                        ...
                        $start=date('Y-m-d',$start);
                        $end=date('Y-m-d'). '23-59-59';
                        $sql="select * from decided where added_on between '$start' and '".date('Y-m-d')." 23-59-59' and status='1'";
                        $res=mysqli_query($con,$sql);
                        if($row=mysqli_num_rows($res)){
                            echo"<h4 class='mb-0'>".$row."</h4>";
                        }else{
    ...
    <?php
    $sql="select * from cases where status='1' order by id desc limit 5";
    $res=mysqli_query($con,$sql);
    ?>
    <div class="row">
        <div class="col-12">
