...
if(isset($_GET['id']) && $_GET['id']>0){
  ...
  if(isset($_GET['procecutor'])){
    ...
    redirect(SITE_PATH.'subadmin/cancel_details.php?id='.$id);
  }

  $sql="SELECT * FROM cases where pro_decision='canceled' and id='$id' ORDER BY id desc";
            ...
            <div class="row">
                ...
                <div>
                  <div class="container-fluid w-100">
                    <a href="#" class="btn btn-primary float-right mt-4 ml-2"><i class="mdi  mdi-folder-download mr-1"></i>Download</a>
                        ...
                        <div>
                        <?php
                        echo "<h4>Reassign to Prosecutor :- ".getProcecutorNameById($courtRow['pcheck_id'])."</h4>"
                        ?>
              ...
              <script>
                function updateprocecutorAssign(){
                  ...
                  if(procecutor!=''){
                    var oid="<?php echo $id?>";
                    window.location.href='<?php echo SITE_PATH?>subadmin/cancel_details.php?id='+oid+'&procecutor='+procecutor;
                  }
                }
