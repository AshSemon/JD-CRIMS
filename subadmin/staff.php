...
$sql="select juser.*,department.abbreviation,role.role from juser,department,role where juser.department_id=department.id and juser.role_id=role.id order by juser.id desc";
...
<div class="main-panel">
    ...
    <div class = "main-title">
            <h3><strong>Wolaita Sodo Justice Department</strong></h3>
        </div>
                ...
                <div class = "item">
                    <div class = "item-img">
                        <a target="_blank" href="img_5terre.jpg">
                            <img src="<?php echo STAFF_IMAGE_SITE_PATH.$row['image']?>" width="600" height="200"/>
                        </a>
                    </div>
                    <div class = "item-detail">
                        <a href = "#" class = "new-price" style="text-transform: capitalize;">Name :  <?php echo $row['name']?></a>
                        <span class = "item-name" style="text-transform: capitalize;">Work Role :  <?php echo $row['role']?></span>
                        <span class = "item-name" style="text-transform: capitalize;">Department :  <?php echo $row['abbreviation']?></span>
                        <div class = "item-price">
                            <span class = "item-price">
                                ...
                                if($row['status']==1){
                                ?>
                                <a href="?id=<?php echo $row['id']?>&type=deactive"><label class="btn btn-success hand_cursor">Active</label></a>
                                <?php } else { ?>
                                    <a href="?id=<?php echo $row['id']?>&type=active"><label class="btn btn-secondary hand_cursor">Deactive</label></a>
                                <?php } ?>
                                &nbsp;
                            </span>
                        </div>
