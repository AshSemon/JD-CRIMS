...
if(isset($_POST['submit'])){
    ...
    $sql="select * from juser where username='$username' and password='$password' and department_id='1' and role_id='5' and status=1";
    $res=mysqli_query($con,$sql);
    if(mysqli_num_rows($res)>0){
      $row=mysqli_fetch_assoc($res);
      $_SESSION['SUBADMIN_IS_LOGIN']='yes';
      $_SESSION['SUBADMIN_USER']=$row['name'];
      $_SESSION['SUBADMIN_USER_NAME']=$row['username'];
      $_SESSION['SUBADMIN_ID']=$row['id'];
      redirect('index.php');
    }else{
