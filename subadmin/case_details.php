...
if(isset($_GET['id']) && $_GET['id']>0){
  ...
  if(isset($_GET['jarchive'])){
    ...
    redirect(SITE_PATH.'subadmin/case_details.php?id='.$id);
  }
            ...
            <div class="row">
                    ...
                    <div class="card-body">
                      ...
                      <div class="container-fluid d-flex justify-content-between">
                        ...
                        <div class="col-lg-3 pr-0">
                          <img src="<?php echo $courtRow['image']?>" alt="" width="200" height="200">
              ...
              <script>
                function updatejarchiveAssign(){
                  ...
                  if(jarchive!=''){
                    var oid="<?php echo $id?>";
                    window.location.href='<?php echo SITE_PATH?>subadmin/case_details.php?id='+oid+'&jarchive='+jarchive;
                  }
                }
