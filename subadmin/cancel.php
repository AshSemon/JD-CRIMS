...
$sql="select * from cases where pro_decision='canceled' order by id desc";
        ...
        <div class = "item-list">
                ...
                <div class = "item">
                    ...
                    <div class = "item-detail">
                        ...
                        <span href = "#" class = "item-name">Prosecutor :  <?php echo getProcecutorNameById($row['prosecutor_id'])?></span>
                        <span href = "#" class = "item-name">Reassign Prosecutor :  <?php echo getProcecutorNameById($row['pcheck_id'])?></span>
                        ...
                        <a href="cancel_details.php?id=<?php echo $row['id']?>"><label class="btn btn-primary mr-2 hand_cursor">View Detail</label></a>
