...
if(isset($_GET['id']) && $_GET['id']>0){
  ...
  if(isset($_GET['jarchive'])){
    ...
    redirect(SITE_PATH.'subadmin/special_details.php?id='.$id);
  }
            ...
            <div class="row">
              ...
              <script>
                function updatejarchiveAssign(){
                  ...
                  if(jarchive!=''){
                    var oid="<?php echo $id?>";
                    window.location.href='<?php echo SITE_PATH?>subadmin/special_details.php?id='+oid+'&jarchive='+jarchive;
                  }
                }
                function updatearchiveAssign(){
                  ...
                  if(archive!=''){
                    var oid="<?php echo $id?>";
                    window.location.href='<?php echo SITE_PATH?>subadmin/special_details.php?id='+oid+'&archive='+archive;
                  }
                }
